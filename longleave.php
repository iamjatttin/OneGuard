...
include 'partials/dbconnect.php';
    ...
    $sql="INSERT INTO leaves (leave_type,leave_id,stdroll,leavedate,dtime,arrival_date,atime,reason) VALUES ( '2','$leave_id','$roll', '$ddate','$dtime', '$arrival_date','$atime', '$reason')";
...
<body>
    ...
    <main class="mt-3">
        ...
        <div class="container-fluid pt-4">
            <div class="row">
                <div class="col-md-8 bg-warning mx-auto">
                    <div class="card">
                        <div class="card-header ">
                            <h2 class="text-center ">Long Leave Request</h2>
                        </div>
                        <div class="card-body">
                            <form action="longleave.php" method="POST">
                                <div class="container-fluid">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="exampleInputdate" name="arrival_date"
                                            id="ddate">
                                    </div>
                                    <div class="mb-3">
