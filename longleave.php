...
<body>
    ...
    <main class="mt-5 pt-3">
        <div class="container-fluid">
            <div class="row">
                <h2 class="mx-auto text-center">LONG LEAVE APPLICATION</h2>
                <div class="col-md-8 mt-5  ms-auto mx-auto">

                    <form action="/OneGuard/OneGuard-master/shortleave.php" method="POST">
                        <div class="container-fluid">
                            <div class="mb-3">
